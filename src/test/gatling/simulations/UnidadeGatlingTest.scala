...
/**
 * Performance test for the Unidade entity.
 */
class UnidadeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Unidade entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created unidade")
                .get("${new_unidade_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created unidade")
            .delete("${new_unidade_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
