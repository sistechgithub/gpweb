...
class ProdutoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Produto entity")
        ...
        .repeat(2) {
            ...
            .post("/api/produtos")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "cdProduto":null, "cdBarras":"SAMPLE_TEXT", "nmProduto":"SAMPLE_TEXT", "cdNcm":"SAMPLE_TEXT", "cdGtin":"SAMPLE_TEXT", "cdAnp":"SAMPLE_TEXT", "dsAnp":"SAMPLE_TEXT", "cdContaContabil":"SAMPLE_TEXT", "materiaPrima":"SAMPLE_TEXT", "flBalanca":null, "flInativo":null, "flSngpc":null, "flUsoProlongado":null, "dsClassTerapeutica":"SAMPLE_TEXT", "vlVenda":null, "vlEstoque":null, "dsInformacoes":"SAMPLE_TEXT", "blImagem":null}""")).asJSON
            .check(status.is(201))
