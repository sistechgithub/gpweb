...
/**
 * Performance test for the Subgrupo entity.
 */
class SubgrupoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Subgrupo entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created subgrupo")
                .get("${new_subgrupo_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created subgrupo")
            .delete("${new_subgrupo_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
